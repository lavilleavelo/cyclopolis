      ...
      <div class="space-y-8 sm:space-y-12">
        <div class="space-y-5 sm:mx-auto sm:max-w-xl sm:space-y-4 lg:max-w-5xl text-center">
          ...
          <p class="text-xl text-gray-500">
            ...
            Le changement de majorité à la Métropole en mars 2026 marque un regrettable coup d'arrêt au développement du réseau,<br />
            mais la Ville à Vélo continuera de faire vivre le plaidoyer sur Cyclopolis.
          </p>
        </div>
      </div>
