      ...
      <div class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6 lg:mt-32">
        <div class="lg:grid lg:grid-cols-12 lg:gap-8">
          ...
          >
            ...
            >
              Une initiative de l'association <strong>{{ assoName }}</strong> pour suivre le développement du nouveau Réseau Cyclable Structurant de Tours Métropole Val de Loire.
            </p>
            <div
